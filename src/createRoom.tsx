...
const CreateRoom = () => {
    ...
    return (
        <div style={{ height: '100vh', width: '100vw', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <div style={{ maxWidth: '424px', height: 'auto', width: '100%', padding: '32px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', borderRadius: '4px', boxShadow: 'rgba(217, 161, 177, 0.54) 1px 2px 4px' }}>
                <div style={{ margin: '0px 0px 24px', display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer' }}>
                ...
                <div style={{ width: '100%', display: 'flex', flex: '1 1 auto', flexDirection: 'column', justifyContent: 'flex-end' }}>
